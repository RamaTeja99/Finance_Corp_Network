...
public class CustomerResource {
    ...
    public Response registerCustomer(Customer customer) {
        try {
            customerService.registerCustomer(customer.getEmployeeId(),customer.getName(), customer.getEmail(), customer.getUsername(), customer.getPassword(), customer.getCustomerType(),customer.getPhone_no());
