...
<body>
    ...
    <div class="center-box">
        ...
        <div class="grid-container">
            <a class="grid-item" href="images/RTI Act 2005.pdf" target="_blank">RTI Act 2005</a>
            <a class="grid-item" href="images/SFCs Act.pdf" target="_blank">SFCs Act</a>
            <a class="grid-item" href="images/General Regulations.pdf" target="_blank">General Regulations</a>
        </div>
    </div>
