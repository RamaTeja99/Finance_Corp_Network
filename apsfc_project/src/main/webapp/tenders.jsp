...
<body>
    ...
    <div class="center-box">
        ...
        <div class="grid-container">
            <a class="grid-item" href="images/Tender forms  SARFAESI Act 2002.pdf" target="_blank">Tender forms: SARFAESI Act 2002</a>
            <a class="grid-item" href="images/Tender forms Sec.29 of SFC Act.pdf" target="_blank">Tender forms- Sec.29 of SFC Act</a>
        </div>
    </div>
